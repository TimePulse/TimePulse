...
describe WorkUnitQuery, :type => :query do
	...
	before :each do
		...
		@billable_work_unit_1 = WorkUnitQuery.new(@user_1,2,'billable')
		@billable_work_unit_2 = WorkUnitQuery.new(@user_2,2,'billable')
		@unbillable_work_unit_1 = WorkUnitQuery.new(@user_1,2,'unbillable')
		@unbillable_work_unit_2 = WorkUnitQuery.new(@user_1,3,'unbillable')
		@total_work_unit_1 = WorkUnitQuery.new(@user_1,3,'total')
	end
